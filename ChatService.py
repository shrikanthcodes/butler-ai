...
def complete_chat(conversation = []):
    ...
    current_conversation.append(Formatting.format_message_to_JSON(lc.roles[1], lc.initial_message))
    
    while True:
        prompt_text = input("Type Next Message: ")
        current_conversation.append({"role": lc.roles[0], "content": prompt_text})
        ...
        current_conversation.append(Formatting.format_message_to_JSON(lc.roles[1], response_message))
